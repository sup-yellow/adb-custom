        ...
        document.querySelector("#chatContainer").insertAdjacentHTML(
           ...
           <div class="overflow-container-header">
                <ul class="header-wrapper" style="display: flex;display: flex;flex-direction: row;align-items: center;background-color: rgb(0, 37, 105);padding: 0;list-style: none;height: 4rem;border: 0.5px solid #ccc;border-left: 0;">
                    <div><img class="sidebar-img-icon" src="https://cdn.yellowmessenger.com/uK85pc6lnzzS1649042448278.png" style="width: 37px; height: auto;margin-left: 10px;margin-right: 10px;vertical-align: middle;"></div><div class="header-title" id="main-header-title" style="font-weight: 400;font-size: medium;color: white;font-family: 'botplatform-font';display: flex;flex-direction: column;margin-left: 0px;">
                    TAMI<div style="/* margin-left: 58px; */font-size: small;">TA Messaging Intelligence</div></div>
                     <div id="fadeshow">
