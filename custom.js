...
function injectDynamicCssToParent() {
  ...
  var parentCssStyles =
    "#ymFrameHolder { width: 100%; } @media only screen and (min-width: 768px) { #ymFrameHolder { width: 440px; } #chatBoxMainContainer{background:red} }";
